<template>
	<view class="my-container gradient pic_background"   style="position: fixed; top: 0; left: 0; right: 0; bottom: 0">
		<view style="overflow-x: hidden;display: flexbox;justify-content: center;align-items: center;">
			<!-- <image mode="aspectFill" src="../../static/HUST碳风格化背景.jpeg" style="position: absolute;height: 100%;z-index: -1;"></image> -->
		</view>
